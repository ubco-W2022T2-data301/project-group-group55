...
def load_and_process(file_path="../../data/raw/Invistico_Airline.csv"):
    ...
    df2 = (df1
    .drop(['Gender','Customer Type','Class','Flight Distance','Seat comfort','Departure/Arrival time convenient',
           ...
           'Departure Delay in Minutes','Arrival Delay in Minutes'], axis=1)
            .assign(Age=pd.cut(df1['Age'], bins=[0, 19, 29, 39, 49, 59, 69, float('inf')], 
